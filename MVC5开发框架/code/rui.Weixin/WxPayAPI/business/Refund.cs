    ...
    public class Refund
    {
        ...
        */
        public static string Run(string transaction_id, string out_trade_no, string total_fee, string refund_fee)
        {
            ...
            data.SetValue("total_fee", rui.typeHelper.toInt(total_fee));//订单总金额
            data.SetValue("refund_fee", rui.typeHelper.toInt(refund_fee));//退款金额
            ...
            rui.logHelper.log(result.ToXml());
