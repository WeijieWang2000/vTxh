...
namespace rui.weixin.WxPayAPI
{
    ...
    public class WxPayData
    {
        ...
        */
        ...
        {
            object o = null;
            dicValues.TryGetValue(key, out o);
            return o;
        }
        ...
        {
            return rui.typeHelper.toString(GetValue(key));
        }
        ...
        **/
        public string ToXml()
        {
            ...
            string xml = "<xml>";
            foreach (KeyValuePair<string, object> pair in dicValues)
            {
                //字段值不能为null，会影响后续流程
                if (pair.Value == null)
                {
        ...
        */
        public SortedDictionary<string, object> FromXml(string xml)
        {
            ...
            foreach (XmlNode xn in nodes)
            {
                ...
                dicValues[xe.Name] = xe.InnerText;//获取xml的键值对到WxPayData内部的数据中
            }
			
            try
            {
				//2015-06-29 错误是没有签名
				if(dicValues["return_code"].ToString() != "SUCCESS")
				{
					return dicValues;
				}
        ...
        */
        ...
        {
            string jsonStr = JsonMapper.ToJson(dicValues);
            return jsonStr;
        }
